...
happiness: {
    ...
    deep_end: {
        text: [
            "The scholarly debate over eudaimonia remains one of the richest in all of philosophy. Whether happiness is an inclusive whole or a dominant activity, and whether it is fragile or resilient, these questions go to the heart of what it means to live well. The readings below will take you deeper into these arguments.",
...
function: {
    ...
    deep_a: {
        text: [
            ...
            "Bernard Williams, in Ethics and the Limits of Philosophy (1985), was more skeptical. Williams argued that even if we grant that humans have a characteristic activity, it does not follow that this activity is good or that we ought to pursue it. Resistance, defiance, even self-destruction can be distinctively human responses. Williams worried that the function argument smuggles in normative assumptions disguised as neutral descriptions of human nature. The gap between what we are and what we should be, Williams insisted, cannot be closed by biology or metaphysics alone.",
    ...
    deep_b: {
        text: [
            "Perhaps the most creative modern development of Aristotle\u2019s function argument is Martha Nussbaum\u2019s capabilities approach, developed in her 1995 essay \u2018Aristotle on Human Nature and the Foundations of Ethics\u2019 and in her broader political philosophy. Nussbaum took Aristotle\u2019s insight \u2014 that the good life requires the exercise of distinctively human capacities \u2014 and transformed it into a framework for global justice.",
